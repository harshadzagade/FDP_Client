            ...
            <section className="bg-white ">
                <div className="grid max-w-screen-xl px-4 pt-20 pb-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12 lg:pt-28">
                    <div className="mr-auto place-self-center lg:col-span-7">
                        <h1 className="max-w-2xl mb-4 text-4xl mt-4 font-bold leading-none tracking-tight md:text-5xl xl:text-6xl text-black lg:text-left md:text-left">
                            5 Days Immersive Hybrid mode FDP <br /> on Case Study Writing
                        </h1>
                        <p className="text-lg font-bold leading-tight text-gray-600 mt-4">
                            7th, 8th, 9th, 10th and 25th January, 2025
                        </p>
                        ...
                        <div className="text-black sm:text-lg ">
                            ...
                            <ul role="list" className="pt-8 space-y-5 border-t border-gray-200 my-7 ">
                                ...
                                <li className="flex space-x-3">
                                    ...
                                    <span className="text-base font-medium leading-tight text-gray-600">Participants
                                        will get an opportunity to publish their case studies</span>
                                </li>
                            </ul>
                        ...
                        <div className="text-gray-500 sm:text-lg ">
                            ...
                            <div className="flex flex-col md:flex-row space-y-8 md:space-y-0 md:space-x-8">
                                <div className="flex flex-col space-y-8 w-full md:w-1/2">
                                    <div>
                                        <h3 className="mb-4 text-3xl font-bold tracking-tight text-red-600 ">Programme Facilitator</h3>
                                        {/* Facilitator 1 */}
                                        <div className="block rounded-lg">
                                            <div className="flex flex-col sm:flex-row items-center sm:items-start rounded-md border border-gray-100 bg-white p-3 shadow-lg">
                                                <img
                            ...
                            <div className="mt-6 overflow-hidden rounded-xl border shadow">
                                <table className="min-w-full border-separate border-spacing-y-2 border-spacing-x-2">
                                    <thead className=" border-b lg:table-header-group">
                                        <tr className="">
                                            <td
                                                className="whitespace-normal py-4 text-center font-bold text-black sm:px-6">
                                                Day & Date
                                            </td>
                                    ...
                                    <tbody className="lg:border-gray-300">
                                        ...
                                        <tr className="">
                                            <td
                                                className="whitespace-no-wrap py-4 text-sm font-bold text-gray-900 sm:px-6">
                                                Wednesday, 8 January 2025 (online)
                                            </td>
                                        ...
                                        <tr className="">
                                            <td
                                                className="whitespace-no-wrap py-4 text-sm font-bold text-gray-900 sm:px-6">
                                                Saturday, 25 January 2025 (offline)
                                            </td>

                                            <td
                                                className="whitespace-no-wrap  py-4 text-sm font-normal text-gray-500 sm:px-6 lg:table-cell">
                                                Participants Case Studies Presentation
                                            </td>
